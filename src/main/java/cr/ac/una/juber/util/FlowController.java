...
import cr.ac.una.juber.App;
import cr.ac.una.juber.controller.Controller;
...
public class FlowController {
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(App.class.getResource("/cr/ac/una/juber/view/MenuView.fxml"), this.idioma)));
            this.mainStage.show();
